...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-reco-fluxnet2015.py"
...
with Dataset("reco.nc", mode="w") as dset:
    ...
    # data
    D = dset.createVariable("reco", data.dtype, ("time", "data"), fill_value = -999)
    D[...]          = data
    D.units         = "kg/m2/s"
    ...
    dset.title = "Ecosystem Respiration, from Daytime partitioning method, reference selected from RECO versions using model efficiency (MEF). The MEF analysis is repeated for each time aggregation"
...
@ARTICLE{Lasslop2010,
  author = {Lasslop, G., M. Reichstein, D. Papale D., A.D. Richardson, A. Arneth, A. Barr, P. Stoy, and G. Wohlfahrt},
