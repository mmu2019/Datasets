...
with Dataset(DataDir + "/reco.nc", mode="w") as dset:
    ...
    dset.source = "Ecosystem Respiration, from Daytime partitioning method, reference selected from RECO versions using model efficiency (MEF). The MEF analysis is repeated for each time aggregation"
    dset.history = """
