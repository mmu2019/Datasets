...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-rlns-fluxnet2015.py"
...
with Dataset(DataDir + "/rlns.nc", mode="w") as dset:
    ...
    dset.source = "Net longwave radiation obtained from LW_IN_F and LW_OUT"
    dset.history = """
