...
VarID         = "rlus"
RawVarID      = "sfc_lw_up_all_mon"
standard_name = "surface upwelling longwave radiation"

# Set general information for the data source
remote_source = "https://ceres.larc.nasa.gov/products-info.php?product=EBAF"
gist_source   = "https://github.com/mmu2019/Datasets/blob/master/read-rlus-ceres.py"
...
with Dataset(DataDir + "/rlus.nc", mode="w") as dset:
