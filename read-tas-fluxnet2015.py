...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-tas-fluxnet2015.py"
...
with Dataset(DataDir + "/tas.nc", mode="w") as dset:
    ...
    dset.source = "Air temperature, gapfilled using MDS method"
    dset.history = """
