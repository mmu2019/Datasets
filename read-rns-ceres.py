...
VarID         = "rns"
RawVarID      = "sfc_net_tot_all_mon"
standard_name = "surface net radiation"

# Set general information for the data source
remote_source = "https://ceres.larc.nasa.gov/products-info.php?product=EBAF"
gist_source   = "https://github.com/mmu2019/Datasets/blob/master/read-rns-ceres.py"
...
with Dataset(DataDir + "/rns.nc", mode="w") as dset:
