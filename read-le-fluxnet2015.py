...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-le-fluxnet2015.py"
...
with Dataset("le.nc", mode="w") as dset:
    ...
    # data
    D = dset.createVariable("le", data.dtype, ("time", "data"), fill_value = -999)
    D[...]          = data
    D.units         = "W/m2"
    ...
    dset.title = "latent heat flux, gapfilled using MDS method"
    dset.version = "2015"
