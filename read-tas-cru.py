...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-tas-cru.py"
local_source = DataDir + '/CRU/v4.02/cru_ts4.02.1901.2017.tmp.dat.nc'
stamp1 = '2019-05-06'
...
filename = DataDir + '/CRU/v4.02/cru_ts4.02.1901.2017.tmp.dat.nc'
print(filename)
...
with Dataset(DataDir + "/tas.nc", mode="w") as dset:
