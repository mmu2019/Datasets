...
local_source = 'CRU/v4.02/cru_ts4.02.1901.2017.dtr.dat.nc'
stamp1 = '2019-05-06'
...
filename = 'CRU/v4.02/cru_ts4.02.1901.2017.dtr.dat.nc'
print(filename)
cru=Dataset(filename,'r',format='NETCDF3')
print(cru) 
print(cru.variables) 

tas  = cru.variables['dtr']
...
with Dataset("dtr.nc", mode="w") as dset:
    ...
    D  = dset.createVariable("dtr"        ,data.dtype,("time","lat","lon"), fill_value = -999.)
    ...
    D[...] = data
    D.units = "K"
    D.standard_name = "2-meter diurnal temperature range"
    ...
    dset.source = "monthly observations of 2-meter maximum and minimum air temperature at meteorological stations across the world land areas"
    dset.history = """
