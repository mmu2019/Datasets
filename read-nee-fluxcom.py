...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-nee-fluxcom.py"
local_source = DataDir + '/FluxCom/nee/NEE.ANN.CRUNCEP_v6.monthly.YYYY.nc'
stamp1 = '2019-05-07'
...
for i in range(nyears):
    ...
    filename = DataDir + '/FluxCom/nee/NEE.ANN.CRUNCEP_v6.monthly.' + str(year) + '.nc'
    print(filename)
    flx=Dataset(filename,'r',format='NETCDF3')
    data0 = flx.variables['NEE']
...
# switch the direction from the original (TER-GPP) to the current (GPP-TER)
data[:,:,:] = -data[:,:,:]
...
%s: redefine the direction: positive means land gain;
