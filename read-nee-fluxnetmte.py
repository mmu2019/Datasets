...
local_source = 'FLUXNET.MTE/nee/YYYY/EnsembleNEE_May09_YYYY.nc'
stamp1 = '2013-12-02'
...
for i in range(nyears):
    ...
    filename = 'FLUXNET.MTE/nee/' + str(year) + '/EnsembleNEE_May09_' + str(year) + '.nc'
    print(filename)
    mte=Dataset(filename,'r',format='NETCDF3')
    data0 = mte.variables['EnsembleNEE_May09']
...
with Dataset("nee.nc", mode="w") as dset:
    ...
    D  = dset.createVariable("nee"        ,data.dtype,("time","lat","lon"), fill_value = -999.)
