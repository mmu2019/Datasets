...
local_source = 'CRU/v4.02/cru_ts4.02.1901.2017.tmx.dat.nc'
stamp1 = '2019-05-06'
...
filename = 'CRU/v4.02/cru_ts4.02.1901.2017.tmx.dat.nc'
print(filename)
cru=Dataset(filename,'r',format='NETCDF3')
print(cru) 
print(cru.variables) 

tas  = cru.variables['tmx']
...
with Dataset("tasmax.nc", mode="w") as dset:
    ...
    D  = dset.createVariable("tasmax"        ,data.dtype,("time","lat","lon"), fill_value = -999.)
    ...
    D[...] = data
    D.units = "K"
    D.standard_name = "2-meter air maximum temperature"
