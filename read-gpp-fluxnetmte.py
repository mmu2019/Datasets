...
local_source = 'FLUXNET.MTE/gpp/YYYY/EnsembleGPP_GL_May09_YYYY.nc'
stamp1 = '2013-12-02'
...
for i in range(nyears):
    ...
    filename = 'FLUXNET.MTE/gpp/' + str(year) + '/EnsembleGPP_GL_May09_' + str(year) + '.nc'
    print(filename)
    mte=Dataset(filename,'r',format='NETCDF3')
    data0 = mte.variables['EnsembleGPP_GL_May09']
