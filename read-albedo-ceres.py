...
VarID         = "albedo"
RawVarID1      = "sfc_sw_down_all_mon"
RawVarID2      = "sfc_sw_up_all_mon"
standard_name = "albedo"
long_name     = "albedo"

# Set general information for the data source
remote_source = "https://ceres.larc.nasa.gov/products-info.php?product=EBAF"
gist_source   = "https://github.com/mmu2019/Datasets/blob/master/read-albedo-ceres.py"
...
pr1  = gpcp.variables[RawVarID1]
pr2  = gpcp.variables[RawVarID2]
...
with Dataset(DataDir + "/albedo.nc", mode="w") as dset:
