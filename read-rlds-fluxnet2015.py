...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-rlds-fluxnet2015.py"
...
with Dataset(DataDir + "/rlds.nc", mode="w") as dset:
    ...
    dset.source = "Longwave radiation, incoming, consolidated from LW_IN_F_MDS and LW_IN_ERA"
    dset.history = """
