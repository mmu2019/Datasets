...
VarID         = "rsus"
RawVarID      = "sfc_sw_up_all_mon"
standard_name = "surface upwelling shortwave radiation"

# Set general information for the data source
remote_source = "https://ceres.larc.nasa.gov/products-info.php?product=EBAF"
gist_source   = "https://github.com/mmu2019/Datasets/blob/master/read-rsus-ceres.py"
...
with Dataset(DataDir + "/rsus.nc", mode="w") as dset:
