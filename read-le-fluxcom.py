...
local_source = DataDir + '/FluxCom/le/LE.RS_METEO.EBC-ALL.MLM-ALL.METEO-GSWP3.720_360.monthly.YYYY.nc'
stamp1 = '2019-05-07'
...
for i in range(nyears):
    ...
    filename = DataDir + '/FluxCom/le/LE.RS_METEO.EBC-ALL.MLM-ALL.METEO-GSWP3.720_360.monthly.' + str(year) + '.nc'
    print(filename)
