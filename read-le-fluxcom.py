...
gist_source = "https://github.com/mmu2019/Datasets/blob/master/read-le-fluxcom.py"
local_source = DataDir + '/FluxCom/le/LE.RS_METEO.EBC-ALL.MLM-ALL.METEO-CRUNCEP_v8.720_360.monthly.YYYY.nc'
stamp1 = '2019-05-07'
...
period = "1980-01 through 2016-12"
origtr = "monthly"
origsr = "0.5 degree"
origut = "MJ/m2/day"
finltr = "monthly"
...
for i in range(nyears):
    ...
    filename = DataDir + '/FluxCom/le/LE.RS_METEO.EBC-ALL.MLM-ALL.METEO-CRUNCEP_v8.720_360.monthly.' + str(year) + '.nc'
    print(filename)
    flx=Dataset(filename,'r',format='NETCDF4')
    data0 = flx.variables['LE']
...
with Dataset(DataDir + "/le.nc", mode="w") as dset:
    ...
    D  = dset.createVariable("le"        ,data.dtype,("time","lat","lon"), fill_value = -999.)
    ...
    D[...] = data
    D.units = "watt/m2"
    D.standard_name = "latent heat flux"
    D.long_name     = long_name
    D.actual_range = np.asarray([data_min,data_max])
    
    dset.title = "FLUXCOM (RS+METEO) Global Land Energy Fluxes using CRUNCEP climate data"
    dset.version = "1"
    dset.institutions = instit
    dset.source = "Data generated by machine learning to merge energy flux measurements from FLUXNET eddy covariance towers with MODIS remote sensing and CRUNCEPv8 meteorological data (RS+METEO)"
    dset.history = """
